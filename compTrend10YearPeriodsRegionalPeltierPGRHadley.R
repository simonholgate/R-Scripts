...
nReqYrLong <- 38   
longFile = 'hadleyAPC/temp27.1948-1998.hadley.apc.sed'
...
for (i in startYr:endYr) {
  shortTrendFile = paste('hadleyAPC/temp27.',as.character(i),'-',
    as.character(i+9),'.hadley.apc.sed', sep="")
#
#nEurope <- numeric(0) 
