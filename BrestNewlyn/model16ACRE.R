...
nstns <- 1 # Number of EOFs to use. 1st 10 contain 91.2% of the data
...
title(main="Model 16: Newlyn", xlab="Year", ylab="Pressure Anomaly [Pa]")
grid(lwd=2)
#dev.off()
x11()
#png(file="model16Brest.png")
...
title(main="Model 16: Brest", xlab="Year", ylab="Pressure Anomaly [Pa]")
grid(lwd=2)
#dev.off()
x11()
#png(file="model16Brest22.png")
...
title(main="Model 16: Brest22", xlab="Year", ylab="Pressure Anomaly [Pa]")
grid(lwd=2)
#dev.off()
