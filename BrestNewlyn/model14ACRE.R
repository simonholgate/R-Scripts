...
nstns <- 10 # Only consider 10 EOFs which contain 91.2% of the data
...
title(main="Model 14: Key West", xlab="Year", ylab="Pressure Anomaly [Pa]")
grid(lwd=2)
#dev.off()
x11()
#png(file="model14SanFran.png")
...
title(main="Model 14: San Francisco", xlab="Year", ylab="Pressure Anomaly [Pa]")
grid(lwd=2)
#dev.off()
