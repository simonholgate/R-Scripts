...
#  model3$data.brest <- data.frame(msl=model3$brestTotalP, t=seq(from=1953,to=2008), Pa=model3$Pa[,1:20])
model3$data.brest <- data.frame(msl=model3$brestTotalP, t=seq(from=1953,to=2008), Pa=model3$Pa[,3:37])
model3$data.brest.partial <- data.frame(msl=model3$brestTotalP[1:37], t=seq(from=1953,to=1989), Pa=model3$Pa[1:37,3:37])
model3$data.brest.new <- data.frame(t=seq(from=1990,to=2008), Pa=model3$Pa[38:56,3:37])
#model3$tg.lmRob.brest <- lmRob(msl ~ ., data=model3$data.brest, control=lmRobControl, na.action=na.exclude)
  model3$tg.lmRob.brest <- lm(msl ~ ., data=model3$data.brest)
model3$tg.lm.brest.partial <- lm(msl ~ ., data=model3$data.brest.partial)
#model3$AIC.tg.lmRob.brest <- step.lmRob(model3$tg.lmRob.brest)
  model3$AIC.tg.lm.brest.partial <- step(model3$tg.lm.brest.partial)
model3$tg.lm.brest.pred <- predict.lm(model3$tg.lm.brest.partial, se.fit=T, newdata=model3$data.brest.new, interval='confidence')
...
model3$data.brest.partial <- data.frame(msl=model3$brestTotalP[1:37],
  t=seq(from=1953,to=1989), model3$Pa[1:37,model3$tg.sd.sorted.brest$ix[1:9]])

model3$tg.lmRob.brest.partial <- lmRob(msl ~ ., x=T, y=T, data=model3$data.brest.partial, control=lmRobControl, na.action=na.exclude)

model3$data.brest.new <- data.frame(t=seq(from=1990,to=2008), model3$Pa[38:56,model3$tg.sd.sorted.brest$ix[1:9]])

model3$tg.lmRob.brest.partial <- lmRob(msl ~ ., data=model3$data.brest.partial)
...
model3$data.brest <- data.frame(msl=model3$brestTotalP,
  ...
  model3$Pa[,model3$tg.rsq.sorted.brest$ix[1:9]])

model3$tg.lmRob.rsq.brest <- lmRob(msl ~ ., x=T, y=T, data=model3$data.brest, control=lmRobControl, na.action=na.exclude)
# Variance reduction
...
model3$data.newlyn.partial <- data.frame(msl=model3$newlynTotalP[1:37],
  t=seq(from=1953,to=1989),
  model3$Pa[1:37,model3$tg.sd.sorted.newlyn$ix[1:9]])
...
model3$data.newlyn.new <- data.frame(t=seq(from=1990,to=2008), model3$Pa[38:56,model3$tg.sd.sorted.newlyn$ix[1:9]])

model3$tg.lmRob.newlyn.partial <- lmRob(msl ~ ., data=model3$data.newlyn.partial)
...
model3$data.newlyn <- data.frame(msl=model3$newlynTotalP,
  t=seq(from=1953,to=2008),
  model3$Pa[,model3$tg.rsq.sorted.newlyn$ix[1:9]])

model3$tg.lmRob.rsq.newlyn <- lmRob(msl ~ ., x=T, y=T, data=model3$data.newlyn, control=lmRobControl, na.action=na.exclude)

# Test model prediction skill
model3$data.newlyn.partial <- data.frame(msl=model3$newlynTotalP[1:37],
  t=seq(from=1953,to=1989),
  model3$Pa[1:37,model3$tg.rsq.sorted.newlyn$ix[1:9]])

model3$tg.lmRob.newlyn.partial <- lmRob(msl ~ ., x=T, y=T, data=model3$data.newlyn.partial, control=lmRobControl, na.action=na.exclude)

model3$data.newlyn.new <- data.frame(t=seq(from=1990,to=2008),
  model3$Pa[38:56,model3$tg.rsq.sorted.newlyn$ix[1:9]])

model3$tg.lmRob.newlyn.partial <- lmRob(msl ~ ., data=model3$data.newlyn.partial)
model3$tg.lmRob.newlyn.pred <- predict.lmRob(model3$tg.lmRob.newlyn.partial, se.fit=T, newdata=model3$data.newlyn.new, interval='confidence')

# SD does a better job for prediction purposes than rsq
...
#model5$data.newlyn.partial <- data.frame(msl=model5$newlynTotalP[38:91],
#  t=seq(from=1953,to=2006),
#  model5$Pa[38:91,model5$tg.sd.sorted.newlyn$ix[1:9]])
#
#model5$tg.lmRob.newlyn.partial <- lmRob(msl ~ ., x=T, y=T,
#                               data=model5$data.newlyn.partial, control=lmRobControl, na.action=na.exclude)
#
#model5$data.newlyn.new <- data.frame(t=seq(from=1916,to=1952),
#  model5$Pa[1:37,model5$tg.sd.sorted.newlyn$ix[1:9]])
#
##model5$tg.lmRob.newlyn.partial <- lmRob(msl ~ ., data=model5$data.newlyn.partial)
#model5$tg.lmRob.newlyn.pred <- predict.lmRob(model5$tg.lmRob.newlyn.partial, se.fit=T, newdata=model5$data.newlyn.new, interval='confidence')
...
# plot(model5$time[1:92], model5$data.delfzijl$msl, lwd=2, ann=F, col='blue', type='b')
