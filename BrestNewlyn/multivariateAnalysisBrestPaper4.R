...
# Try 5 year running mean as per Bruce.
trian5ptFilter<-c(1,2,3,2,1)
trian5ptFilter<-trian5ptFilter/sum(trian5ptFilter)
tg_annual$filt.delfzijl1916<-filter(tg_annual$delfzijl1916$Height,trian5ptFilter,method="c",sides=2)
tg_annual$filt.brest1916<-filter(tg_annual$brest1916$Height,trian5ptFilter,method="c",sides=2)
tg_annual$filt.newlyn<-filter(tg_annual$newlyn$Height,trian5ptFilter,method="c",sides=2)

tg_annual$filt.delfzijl<-filter(tg_annual$delfzijl$Height,trian5ptFilter,method="c",sides=2)
tg_annual$filt.brest<-filter(tg_annual$brest$Height,trian5ptFilter,method="c",sides=2)

#x11()
#plot(tg_annual$newlyn$Year, tg_annual$filt.brest1916, type='l', col='blue', ylim=c(-200,300))
#lines(tg_annual$newlyn$Year, tg_annual$filt.newlyn, col='red')
#lines(tg_annual$newlyn$Year[1:92], tg_annual$filt.delfzijl1916, col='magenta')

#plot(tg_annual$brest$Year, tg_annual$filt.brest, type='l', col='blue', ylim=c(-200,150))
#lines(tg_annual$delfzijl$Year, tg_annual$filt.delfzijl, col='magenta')
...
# Post war period: 15/1/1953-15/12/2008
tg_monthly$brest5308 <- tg_monthly$brestMonthly[intersect(which(tg_monthly$time>=as.Date("1953/1/15")), which(tg_monthly$time<=as.Date("2008/12/15")))]
tg_monthly$time5308 <- tg_monthly$time[intersect(which(tg_monthly$time>=as.Date("1953/1/15")), which(tg_monthly$time<=as.Date("2008/12/15")))]
tg_monthly$brest5308.orig <- tg_monthly$brest5308
tg_monthly$brest5308[which(is.na(tg_monthly$brest5308))] <- mean(tg_monthly$brest5308, na.rm=T)

tg_monthly$newlyn5308 <- tg_monthly$newlynMonthly[intersect(which(tg_monthly$time>=as.Date("1953/1/15")), which(tg_monthly$time<=as.Date("2008/12/15")))]
tg_monthly$newlyn5308.orig <- tg_monthly$newlyn5308
# Fill missing Newlyn value with the mean
tg_monthly$newlyn5308[which(is.na(tg_monthly$newlyn5308))] <- mean(tg_monthly$newlyn5308, na.rm=T)

# Remove linear trend and intercept from Newlyn and Brest over model period
tg_monthly$brest5308.lmRob <- lmRob(tg_monthly$brest5308 ~ as.Date(tg_monthly$time5308))
tg_monthly$newlyn5308.lmRob <- lmRob(tg_monthly$newlyn5308 ~ as.Date(tg_monthly$time5308))
tg_monthly$resid5308.diff <- tg_monthly$newlyn5308.lmRob$resid-tg_monthly$brest5308.lmRob$resid
...
for(i in 1:(met$hadNUniq*3)){
  ...
  model3$tg.rsq.brest[i] <- model3$tg.lmRob.brest$r.sq
}

# Now we can sort these sds. Thompson took the first 9 and we will do the same for
# comparison. 
model3$tg.sd.sorted.brest <- sort(model3$tg.sd.brest, index=TRUE)
model3$tg.rsq.sorted.brest <- sort(model3$tg.rsq.brest, index=TRUE, decreasing=TRUE)
...
model3$data.brest <- data.frame(msl=model3$brestTotalP,
  t=seq(from=1953,to=2008),
  Pa1=model3$Pa[,model3$tg.rsq.sorted.brest$ix[1]], 
  Pa2=model3$Pa[,model3$tg.rsq.sorted.brest$ix[2]], Pa3=model3$Pa[,model3$tg.rsq.sorted.brest$ix[3]],
  Pa4=model3$Pa[,model3$tg.rsq.sorted.brest$ix[4]], Pa5=model3$Pa[,model3$tg.rsq.sorted.brest$ix[5]],
  Pa6=model3$Pa[,model3$tg.rsq.sorted.brest$ix[6]], Pa7=model3$Pa[,model3$tg.rsq.sorted.brest$ix[7]],
  Pa8=model3$Pa[,model3$tg.rsq.sorted.brest$ix[8]], Pa9=model3$Pa[,model3$tg.rsq.sorted.brest$ix[9]])

model3$tg.lmRob.rsq.brest <- lmRob(msl ~ t + Pa1 + Pa2 + Pa3 + Pa4 + Pa5 + Pa6 + Pa7 + Pa8 + Pa9, x=T, y=T,
                               data=model3$data.brest, control=lmRobControl)
# Variance reduction
...
#[1] 0.7240837
#> model3$tg.lmRob.rsq.brest$r.sq
#[1] 0.738547
...
for(i in 1:(met$hadNUniq*3)){
  ...
  model3$tg.rsq.newlyn[i] <- model3$tg.lmRob.newlyn$r.sq
}

# Now we can sort these sds. Thompson took the first 9 and we will do the same for
# comparison. 
model3$tg.sd.sorted.newlyn <- sort(model3$tg.sd.newlyn, index=TRUE)
model3$tg.rsq.sorted.newlyn <- sort(model3$tg.rsq.newlyn, index=TRUE, decreasing=TRUE)
...
model3$data.newlyn <- data.frame(msl=model3$newlynTotalP,
  t=seq(from=1953,to=2008),
  Pa1=model3$Pa[,model3$tg.rsq.sorted.newlyn$ix[1]], 
  Pa2=model3$Pa[,model3$tg.rsq.sorted.newlyn$ix[2]], Pa3=model3$Pa[,model3$tg.rsq.sorted.newlyn$ix[3]],
  Pa4=model3$Pa[,model3$tg.rsq.sorted.newlyn$ix[4]], Pa5=model3$Pa[,model3$tg.rsq.sorted.newlyn$ix[5]],
  Pa6=model3$Pa[,model3$tg.rsq.sorted.newlyn$ix[6]], Pa7=model3$Pa[,model3$tg.rsq.sorted.newlyn$ix[7]],
  Pa8=model3$Pa[,model3$tg.rsq.sorted.newlyn$ix[8]], Pa9=model3$Pa[,model3$tg.rsq.sorted.newlyn$ix[9]])

model3$tg.lmRob.rsq.newlyn <- lmRob(msl ~ t + Pa1 + Pa2 + Pa3 + Pa4 + Pa5 + Pa6 + Pa7 + Pa8 + Pa9, x=T, y=T,
                               data=model3$data.newlyn, control=lmRobControl)
...
#> model3$tg.lmRob.rsq.newlyn$r.sq
#[1] 0.7363964
#> c(coef(model3$tg.lmRob.rsq.brest)[2]/10.045, coef(model3$tg.lmRob.rsq.newlyn)[2]/10.045)
#       t        t 
#1.990406 1.776021 
#> c(sqrt(diag(model3$tg.lmRob.rsq.brest$cov))[2]/10.045,  sqrt(diag(model3$tg.lmRob.rsq.newlyn$cov))[2]/10.045)
#        t         t 
#0.5384011 0.4098649
...
model4$data.brest <- data.frame(msl=model4$brestTotalP,
  t=seq(from=1916,to=1943),
  Pa1=model4$Pa[,model4$tg.rsq.sorted.brest$ix[1]], 
  Pa2=model4$Pa[,model4$tg.rsq.sorted.brest$ix[2]], Pa3=model4$Pa[,model4$tg.rsq.sorted.brest$ix[3]],
  Pa4=model4$Pa[,model4$tg.rsq.sorted.brest$ix[4]], Pa5=model4$Pa[,model4$tg.rsq.sorted.brest$ix[5]],
  Pa6=model4$Pa[,model4$tg.rsq.sorted.brest$ix[6]], Pa7=model4$Pa[,model4$tg.rsq.sorted.brest$ix[7]],
  Pa8=model4$Pa[,model4$tg.rsq.sorted.brest$ix[8]], Pa9=model4$Pa[,model4$tg.rsq.sorted.brest$ix[9]])

model4$tg.lmRob.rsq.brest <- lmRob(msl ~ t + Pa1 + Pa2 + Pa3 + Pa4 + Pa5 + Pa6 + Pa7 + Pa8 + Pa9, x=T, y=T,
                               data=model4$data.brest, control=lmRobControl)
# Variance reduction
...
model4$data.newlyn <- data.frame(msl=model4$newlynTotalP,
  t=seq(from=1916,to=1943),
  Pa1=model4$Pa[,model4$tg.rsq.sorted.newlyn$ix[1]], 
  Pa2=model4$Pa[,model4$tg.rsq.sorted.newlyn$ix[2]], Pa3=model4$Pa[,model4$tg.rsq.sorted.newlyn$ix[3]],
  Pa4=model4$Pa[,model4$tg.rsq.sorted.newlyn$ix[4]], Pa5=model4$Pa[,model4$tg.rsq.sorted.newlyn$ix[5]],
  Pa6=model4$Pa[,model4$tg.rsq.sorted.newlyn$ix[6]], Pa7=model4$Pa[,model4$tg.rsq.sorted.newlyn$ix[7]],
  Pa8=model4$Pa[,model4$tg.rsq.sorted.newlyn$ix[8]], Pa9=model4$Pa[,model4$tg.rsq.sorted.newlyn$ix[9]])

model4$tg.lmRob.rsq.newlyn <- lmRob(msl ~ t + Pa1 + Pa2 + Pa3 + Pa4 + Pa5 + Pa6 + Pa7 + Pa8 + Pa9, x=T, y=T,
                               data=model4$data.newlyn, control=lmRobControl)
# Variance reduction
...
model5$tg.lmRob.brestTotalP <- lmRob(model5$brestTotalP ~ model5$time, x=T, y=T, control=lmRobControl)
model5$tg.lmRob.brestTotalP_22<- lmRob(model5$brestTotalP_22 ~ model5$time, control=lmRobControl)
model5$tg.lmRob.newlynTotalP <- lmRob(model5$newlynTotalP ~ model5$time, x=T, y=T, control=lmRobControl)
...
model5$data.brest <- data.frame(msl=model5$brestTotalP,
  t=seq(from=1916,to=2008),
  Pa1=model5$Pa[,model5$tg.rsq.sorted.brest$ix[1]], 
  Pa2=model5$Pa[,model5$tg.rsq.sorted.brest$ix[2]], Pa3=model5$Pa[,model5$tg.rsq.sorted.brest$ix[3]],
  Pa4=model5$Pa[,model5$tg.rsq.sorted.brest$ix[4]], Pa5=model5$Pa[,model5$tg.rsq.sorted.brest$ix[5]],
  Pa6=model5$Pa[,model5$tg.rsq.sorted.brest$ix[6]], Pa7=model5$Pa[,model5$tg.rsq.sorted.brest$ix[7]],
  Pa8=model5$Pa[,model5$tg.rsq.sorted.brest$ix[8]], Pa9=model5$Pa[,model5$tg.rsq.sorted.brest$ix[9]])

model5$tg.lmRob.rsq.brest <- lmRob(msl ~ t + Pa1 + Pa2 + Pa3 + Pa4 + Pa5 + Pa6 + Pa7 + Pa8 + Pa9, x=T, y=T,
                               data=model5$data.brest, control=lmRobControl)
...
model5$data.brest <- data.frame(msl=model5$brestTotalP_22,
  t=seq(from=1916,to=2008),
  Pa1=model5$Pa[,model5$tg.rsq.sorted.brest_22$ix[1]], 
  Pa2=model5$Pa[,model5$tg.rsq.sorted.brest_22$ix[2]], Pa3=model5$Pa[,model5$tg.rsq.sorted.brest_22$ix[3]],
  Pa4=model5$Pa[,model5$tg.rsq.sorted.brest_22$ix[4]], Pa5=model5$Pa[,model5$tg.rsq.sorted.brest_22$ix[5]],
  Pa6=model5$Pa[,model5$tg.rsq.sorted.brest_22$ix[6]], Pa7=model5$Pa[,model5$tg.rsq.sorted.brest_22$ix[7]],
  Pa8=model5$Pa[,model5$tg.rsq.sorted.brest_22$ix[8]], Pa9=model5$Pa[,model5$tg.rsq.sorted.brest_22$ix[9]])

model5$tg.lmRob.rsq.brest_22 <- lmRob(msl ~ t + Pa1 + Pa2 + Pa3 + Pa4 + Pa5 + Pa6 + Pa7 + Pa8 + Pa9, x=T, y=T,
                               data=model5$data.brest, control=lmRobControl)
# Variance reduction
...
model5$data.newlyn <- data.frame(msl=model5$newlynTotalP,
  t=seq(from=1916,to=2008),
  Pa1=model5$Pa[,model5$tg.rsq.sorted.newlyn$ix[1]], 
  Pa2=model5$Pa[,model5$tg.rsq.sorted.newlyn$ix[2]], Pa3=model5$Pa[,model5$tg.rsq.sorted.newlyn$ix[3]],
  Pa4=model5$Pa[,model5$tg.rsq.sorted.newlyn$ix[4]], Pa5=model5$Pa[,model5$tg.rsq.sorted.newlyn$ix[5]],
  Pa6=model5$Pa[,model5$tg.rsq.sorted.newlyn$ix[6]], Pa7=model5$Pa[,model5$tg.rsq.sorted.newlyn$ix[7]],
  Pa8=model5$Pa[,model5$tg.rsq.sorted.newlyn$ix[8]], Pa9=model5$Pa[,model5$tg.rsq.sorted.newlyn$ix[9]])

model5$tg.lmRob.rsq.newlyn <- lmRob(msl ~ t + Pa1 + Pa2 + Pa3 + Pa4 + Pa5 + Pa6 + Pa7 + Pa8 + Pa9, x=T, y=T,
                               data=model5$data.newlyn, control=lmRobControl)
# Variance reduction
...
#> model5$tg.lmRob.rsq.newlyn$r.sq
#[1] 0.808597
#c(coef(model5$tg.lmRob.rsq.brest)[2]/10.045, coef(model5$tg.lmRob.rsq.brest_22)[2]/10.045, coef(model5$tg.lmRob.rsq.newlyn)[2]/10.045)
#       t        t        t 
#1.465178 1.807989 1.815596
#c(sqrt(diag(model5$tg.lmRob.rsq.brest$cov))[2]/10.045, sqrt(diag(model5$tg.lmRob.rsq.brest_22$cov))[2]/10.045, sqrt(diag(model5$tg.lmRob.rsq.newlyn$cov))[2]/10.045)
#        t         t         t 
#0.2913807 0.1534389 0.1064013
...
model10$tg.lmRob.brestTotalP <- lmRob(model10$brestTotalP ~ model10$time, x=T, y=T, control=lmRobControl)
model10$tg.lmRob.newlynTotalP <- lmRob(model10$newlynTotalP ~ model10$time, x=T, y=T, control=lmRobControl)
...
for(i in 1:(met$hadNUniq*3)){
  ...
  model10$tg.lmRob.brest <- lmRob(msl ~ t + Pa, data=model10$data.brest, control=lmRobControl)
...
model10$tg.lmRob.brest <- lmRob(msl ~ t + Pa1 + Pa2 + Pa3 + Pa4 + Pa5 + Pa6 + Pa7 + Pa8 + Pa9, x=T, y=T,
                               data=model10$data.brest, control=lmRobControl)
model10$tg.lmRob.brest.fitted.lm <- lmRob(model10$tg.lmRob.brest$fitted  ~ model10$tg.lmRob.brest$x[,2], control=lmRobControl)
...
for(i in 1:(met$hadNUniq*3)){
  ...
  model10$tg.lmRob.newlyn <- lmRob(msl ~ t + Pa, data=model10$data.newlyn, control=lmRobControl)
...
model10$tg.lmRob.newlyn <- lmRob(msl ~ t + Pa1 + Pa2 + Pa3 + Pa4 + Pa5 + Pa6 + Pa7 + Pa8 + Pa9, x=T, y=T,
                               data=model10$data.newlyn, control=lmRobControl)
model10$tg.lmRob.newlyn.fitted.lm <- lmRob(model10$tg.lmRob.newlyn$fitted  ~ model10$tg.lmRob.newlyn$x[,2], control=lmRobControl)
...
model11$tg.lmRob.brestTotalP <- lmRob(model11$brestTotalP ~ model11$time, control=lmRobControl)
...
for(i in 1:(met$hadNUniq*3)){
  ...
  model11$tg.lmRob.brest <- lmRob(msl ~ t + Pa, data=model11$data.brest, control=lmRobControl)
...
model11$tg.lmRob.brest <- lmRob(msl ~ t + Pa1 + Pa2 + Pa3 + Pa4 + Pa5 + Pa6 + Pa7 + Pa8 + Pa9, x=T, y=T,
                               data=model11$data.brest, control=lmRobControl)
...
model13$tg.lmRob.brestTotalP <- lmRob(model13$brestTotalP ~ model13$time, x=T, y=T, control=lmRobControl)
model13$tg.lmRob.brestTotalP_22<- lmRob(model13$brestTotalP_22 ~ model13$time, control=lmRobControl)
model13$tg.lmRob.newlynTotalP <- lmRob(model13$newlynTotalP ~ model13$time, x=T, y=T, control=lmRobControl)
...
model13$tg.lmRob.brest <- lmRob(msl ~ t + EOF1 + EOF2 + EOF3 + EOF4 + EOF5 + EOF6 + EOF7 + EOF8 + EOF9 + EOF10
                                ...
                                x=T, y=T, data=model13$data.brest, control=lmRobControl)
model13$tg.lmRob.brest.fitted.lm <- lmRob(model13$tg.lmRob.brest$fitted  ~ model13$tg.lmRob.brest$x[,2], control=lmRobControl)
...
model13$tg.lmRob.newlyn<- lmRob(msl ~ t + EOF1 + EOF2 + EOF3 + EOF4 + EOF5 + EOF6 + EOF7 + EOF8 + EOF9 + EOF10
                                + EOF11 + EOF12 + EOF13 + EOF14,
                                x=T, y=T, data=model13$data.newlyn, control=lmRobControl)

model13$tg.lmRob.newlyn.fitted.lm <- lmRob(model13$tg.lmRob.newlyn$fitted  ~ model13$tg.lmRob.newlyn$x[,2], control=lmRobControl)
