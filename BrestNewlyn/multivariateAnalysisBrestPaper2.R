...
met$hadnstns <- 37
met$hadSLP2rAnnualPressureArray <- array(NA, dim=c(158,met$hadnstns))
...
model3$Pa <- array(NA,dim=c(47,(met$hadNUniq*3)))
# Zero lag
for(i in 1:met$hadNUniq){
...
# Lag 1 year
for(i in (met$hadNUniq+1):(met$hadNUniq*2)){
  model3$Pa[,i] <- as.vector(met$hadSLP2rAnnualPressureArray[103:149,met$hadSLP2rUniq[(i-met$hadNUniq)]])
}
# Lag 2 years....
for(i in ((met$hadNUniq*2)+1):(met$hadNUniq*3)){
  model3$Pa[,i] <- as.vector(met$hadSLP2rAnnualPressureArray[102:148,met$hadSLP2rUniq[(i-(met$hadNUniq*2))]])
}
...
model5$Pa <- array(NA,dim=c(84,(met$hadNUniq*3)))
# Zero lag
for(i in 1:met$hadNUniq){
...
# Lag 1 year
for(i in (met$hadNUniq+1):(met$hadNUniq*2)){
  model5$Pa[,i] <- as.vector(met$hadSLP2rAnnualPressureArray[66:149,met$hadSLP2rUniq[(i-met$hadNUniq)]])
}
# Lag 2 years....
for(i in ((met$hadNUniq*2)+1):(met$hadNUniq*3)){
  model5$Pa[,i] <- as.vector(met$hadSLP2rAnnualPressureArray[65:148,met$hadSLP2rUniq[(i-(met$hadNUniq*2))]])
}
