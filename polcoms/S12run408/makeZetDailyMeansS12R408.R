###############################################################################
# Variation of makeZetDailyMeans.r 
# This version calculates the 2D daily mean sea level from the
# POLCOMS S12run408model output which has open ocean forcing and runs to 2004.
# 
# Note that these output files are ow little endian rather than the big endian 
# files of S12run405.
#
# The filtering of tides requires reading 39 2D arrays (19 either side of
...
inname<-c( 
"zet_UBVB.S12run408.jan",
"zet_UBVB.S12run408.feb",
"zet_UBVB.S12run408.mar",
"zet_UBVB.S12run408.apr",
"zet_UBVB.S12run408.may",
"zet_UBVB.S12run408.jun",
"zet_UBVB.S12run408.jul",
"zet_UBVB.S12run408.aug",
"zet_UBVB.S12run408.sep",
"zet_UBVB.S12run408.oct",
"zet_UBVB.S12run408.nov",
"zet_UBVB.S12run408.dec" 
)
...
yearsArray<-array(data=
  ...
  2000,2001,2002,2003,2004), dim=c(45,1))
#  c(1990), dim=c(1,1))
...
# Test for leap year
  ...
  for (ii in 1:nmons) {
    ...
    fname <- paste("S12run408ZetFiles/",inname[ii], substr(as.character(yearsArray[jj]),3,4),sep="")
...
# Read data
    junk<-readBin(inConn, what="integer", n = 4, size = NA, endian = "little")
...
# Size of array need for Doodson filter is 39
    zet<-array(0,dim=c(npsea,39))

# Read junk first integer that Fortran writes
    junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
# Read data
    isea<-readBin(inConn, what="integer", n = npsea, size = NA, endian = "little")
# Read junk last integer that Fortran writes
    junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
...
# Read junk first integer that Fortran writes
    junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
# Read data
    jsea<-readBin(inConn, what="integer", n = npsea, size = NA, endian = "little")
# Read junk last integer that Fortran writes
    junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
...
# Read junk first integer that Fortran writes
    junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
# Read data
    iusea<-readBin(inConn, what="integer", n = npusea, size = NA, endian = "little")
# Read junk last integer that Fortran writes
    junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
...
# Read junk first integer that Fortran writes
    junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
# Read data
    jusea<-readBin(inConn, what="integer", n = npusea, size = NA, endian = "little")
# Read junk last integer that Fortran writes
    junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
...
# Read junk first integer that Fortran writes
      junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
# Read data
      itimt<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
# Read junk last integer that Fortran writes
      junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
...
# Read junk first integer that Fortran writes
      junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
# Read sea level data
      zett<-readBin(inConn, what="numeric", n = npsea, size = 4, endian = "little")
# Read junk last integer that Fortran writes
      junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
...
# Read junk first integer that Fortran writes
      junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
# Read data
      uvbt<-readBin(inConn, what="numeric", n = npusea, size = 4, endian = "little")
# Read junk last integer that Fortran writes
      junk1<-readBin(inConn, what="integer", n = 1, size = NA, endian = "little")
